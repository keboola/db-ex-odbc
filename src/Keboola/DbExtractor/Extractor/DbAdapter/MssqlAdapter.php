...
class MssqlAdapter implements PdoInterface
{
    ...
    public function query($statement, $bind = [], $mode = 19, $arg3 = null, array $ctorargs = []): PdoStatementInterface
    {
        try {
            ...
            throw MssqlAdapterException::fromQueryAndPreviousException($statement, $e);
        }
    }
    ...
    {
        throw MssqlAdapterException::fromMessage('Not implemented yet');
        return false;
    }
    ...
    public function quote($string, $parameterType = PdoInterface::PARAM_STR): string
    {
        ...
        throw MssqlAdapterException::fromMessage(sprintf('Cannot quote "%s" parameter type', $parameterType));
    }
}
